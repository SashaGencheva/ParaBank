...
public class GetUserDetailsApiTest extends HooksApi {
    String sysPath;
    File jsonData;
    ObjectMapper mapper;
    Users user;
    ...
    @Test
    public void getUserDetailsApiTest(ITestContext context) throws IOException {
        ...
        url = customerApiUrl + expectedUserId;
